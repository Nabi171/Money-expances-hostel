...
document.getElementById('calculate-btn').addEventListener('click', function () {
    ...
    if (monthlyIncomeAmount > 0 && foodExpansesAmount > 0 && rentExpansesAmount > 0 && clothesExpansesAmount > 0) {
        ...
        const monthlyIncomeAmount = evaluateInputField('monthly-income');
        if (clothesExpansesAmount < monthlyIncomeAmount) {
...
document.getElementById('save-btn').addEventListener('click', function () {
    ...
    const monthlyIncomeAmount = evaluateInputField('monthly-income');
    if (savePercentageAmount > 0 && monthlyIncomeAmount > 0) {
    ...
    else if (savePercentageAmount !== "number" && monthlyIncomeAmount !== "number") {
        alert('this is string ,please pass a number');
    }
    else {
